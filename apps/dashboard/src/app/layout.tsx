        ...
        <main className="flex-1 flex flex-col min-w-0 overflow-y-auto h-screen">
          <header className="h-14 border-b border-gray-800 bg-[#0d1321]/80 backdrop-blur px-6 flex items-center justify-between sticky top-0 z-10 shrink-0">
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-400">Autonomous Operation:</span>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400"></span> Active
              </span>
            </div>
            <div className="flex items-center gap-4 text-xs">
              <span className="text-gray-400 font-mono">Daily Budget: <strong className="text-white">$5.00</strong></span>
              <span className="text-gray-400 font-mono">Cost Today: <strong className="text-emerald-400">$0.12</strong></span>
            </div>
          </header>
