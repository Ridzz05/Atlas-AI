  ...
  return (
    <aside className="w-64 border-r border-gray-800 bg-[#0d1321] flex flex-col justify-between shrink-0 h-screen sticky top-0">
      <div>
        <div className="p-5 border-b border-gray-800 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400 font-mono tracking-wider">v0.1.0 • PRODUCTION</p>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-gray-800">
        <button
          onClick={() => alert('🚨 Emergency stop signal sent: All runs cancelled and external writes frozen.')}
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-rose-600/20 hover:bg-rose-600/30 text-rose-400 border border-rose-500/30 text-xs font-medium transition-all"
        >
