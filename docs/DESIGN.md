...
- [React transitions](https://mui.com/material-ui/transitions.md): Transitions help to make a UI expressive and easy to use.
...
- [Focus visible](https://mui.com/material-ui/customization/focus-visible.md): Apply an outline or inset keyboard focus across Material UI components.
...
- [Transitions](https://mui.com/material-ui/customization/transitions.md): These theme helpers allow you to create custom CSS transitions, and you can customize the durations, easings, and more.
