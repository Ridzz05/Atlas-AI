...
- [x] Add a mandatory `pnpm audit --audit-level high` CI gate; the latest lockfile audit reports zero high/critical findings and registry signatures are verified for 331 packages.
