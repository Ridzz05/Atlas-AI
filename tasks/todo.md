...
- [x] Add in-process versioned rubric definitions, threshold validation, and per-dimension evidence validation; persisted operational rubric configuration remains a follow-up.
