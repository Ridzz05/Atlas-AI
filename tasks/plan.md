...
- Git history now includes the implementation slices through `a3a42aa`; the original `a6efa4f` “complete” commit was a scaffold checkpoint, not a production proof.
