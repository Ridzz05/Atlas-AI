...
- Git history now includes the implementation slices through `22b88ae`; the original `a6efa4f` “complete” commit was a scaffold checkpoint, not a production proof.
