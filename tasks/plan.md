...
- Git history now includes the implementation slices through `cc25b8b`; the original `a6efa4f` “complete” commit was a scaffold checkpoint, not a production proof.
